# <div style="position: absolute; top: 12%; left: 30%; transform: translate(-50%, -50%); z-index: 2; font-family: 'Times New Roman', serif; font-size: 48px; color: white; text-align: center;">Welcome to Wang Cong's homepage!</div>

## </br></br></br></br></br></br></br><div style="font-family:'仿宋'; font-size:25px">一、生物信息学笔记</div>
==特别注意==：本门课并非教授编程技能，而是训练学生**如何使用编程解决实际问题**。
### <font size=4>1. **课程基本信息介绍**</font>
...
## <font face="仿宋" size=5>二、生物信息学习计划
# 生物信息学学习计划（16 周）
...
- **内容**：
  ...
  - 第 16 周：项目实践与总结（结合 R 和 Python 完成一个小型项目）。
